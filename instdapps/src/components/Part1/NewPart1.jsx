...
const NewPart1 = () => {
  ...
  return (
    <Grid container justifyContent="space-between" className={classes.part1} spacing={5}>
          ...
          <div style={{lineHeight:"4rem"}} className = "part1">
              ...
              <Grid item style={{textAlign:"left"}} md={12}>
                <Grid container spacing = {1}>
                    <Grid style={{textAlign:"left"}} item xs={12} md = {6}><Button style={{textTransform: 'titlecase'}} variant = "outlined">Dashboard</Button></Grid>
                    <Grid style={{textAlign:"left"}} item xs={12} md = {6}><Button style={{textTransform: 'titlecase'}} variant = "outlined">Dashboard</Button></Grid>
                </Grid>
                </Grid>
                </div>
      ...
      <Grid item xs={12} md={6}>
        <img src = {Part1img} height="100%" width = "100%"></img>
      </Grid>
    </Grid>
  );
};
